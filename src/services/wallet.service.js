...
async function debitWallet(client, { walletId, amount, fee = 0, type, provider, providerReference, counterparty, narration, meta, offlineQueueId }) {
  ...
  const { rows: txnRows } = await client.query(
    `INSERT INTO transactions
     ...
     VALUES ($1,$2,$3,'debit',$4,$5,$6,$7,'success',$8,$9,$10,$11,$12,$13,$14,$15)
     RETURNING *`,
